...
\begin{figure}
	\centering
	\includegraphics{assets/template/ostfalia_logo.jpg}
...
\lstinputlisting[caption={Some Code},float,language=Html]{assets/listings/index.html}
...
\lstinputlisting[caption={Some Code},float,language=Java]{assets/listings/helloworld.java}
