...
\usepackage[bottom]{footmisc} % Display footnotes at the bottom of the page

\setlength{\parindent}{0em} % Left paragraph indentation
\setlength{\marginparwidth}{2cm} % Removes a warning thrown by the 'todonotes' package. This is only needed in the draft an can be commented out afterwards.
